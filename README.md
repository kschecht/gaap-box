...
<ul>
    ...
    <li>use an SQL (or MySQL or NoSQL idk) database to store entries
        <ul>
            ...
            <li><table><tr><td><strong>EntryID</strong></td><td>EntryContent</td><td>UserID <em>(will be null for now)</em></td></tr><tr><td> </td><td> </td><td> </td></tr><tr><td> </td><td> </td><td> </td></tr></table></li>
        </ul>
    </li>
